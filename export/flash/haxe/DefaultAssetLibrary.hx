...
@:keep class __ASSET__assets_data_map_oep extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_data_room_001_oel extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_data_room_002_oel extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_images_candy_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/map.oep") class __ASSET__assets_data_map_oep extends flash.utils.ByteArray {}
@:file("assets/data/room-001.oel") class __ASSET__assets_data_room_001_oel extends flash.utils.ByteArray {}
@:file("assets/data/room-002.oel") class __ASSET__assets_data_room_002_oel extends flash.utils.ByteArray {}
@:bitmap("assets/images/candy.png") class __ASSET__assets_images_candy_png extends flash.display.BitmapData {}
